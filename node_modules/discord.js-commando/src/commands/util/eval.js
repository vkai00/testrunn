...
module.exports = class EvalCommand extends Command {
	constructor(client) {
		super(client, {
			...
			details: 'Only Kai may use this command. Go away idiot :3',
			ownerOnly: true,

			args: [
				{
					key: 'script',
					prompt: 'What code would you like to evaluate, my God?',
					type: 'string'
				}
			]
		});
	...
	run(msg, args) {
		...
		try {
			...
			return msg.reply(`Error while evaluating, fix your retarded code Kai: \`${err}\``);
		}
